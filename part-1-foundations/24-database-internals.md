...
- Ch 24b (SQL mastery and graph databases — the practical query patterns that build on these internals)
...
For practical SQL patterns (CTEs, window functions, lateral joins) and alternative database models (graph databases), continue to **[Chapter 24b: SQL Mastery & Graph Databases](./24b-sql-mastery-graph-databases.md)**.
