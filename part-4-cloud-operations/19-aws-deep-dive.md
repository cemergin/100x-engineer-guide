<!--
  ...
  KEY_TOPICS: EC2, Lambda, ECS, VPC, S3, DynamoDB, RDS, SQS, SNS, EventBridge, IAM, CloudWatch, CloudFront, API Gateway, Cost Optimization
  DIFFICULTY: Intermediate → Advanced
  UPDATED: 2026-03-24
-->

# Chapter 19: AWS Deep Dive
...
Let's be honest about what cloud platforms actually are. AWS is 200+ managed services layered on top of the same physical hardware you could rent yourself — but the layering is the product. This chapter gives you the real deal on the 20 AWS services that power 95% of production workloads, the networking and security model underneath them, and how to deploy frontends correctly.
...
- **[L2-M44: Terraform & Infrastructure as Code](../course/modules/loop-2/L2-M44-terraform-and-iac.md)** — Replace click-ops with Terraform modules for TicketPulse's AWS infrastructure
- **[L3-M62: Cloud Provider Deep Dive](../course/modules/loop-3/L3-M62-cloud-provider-deep-dive.md)** — Go beyond the basics: ALB routing rules, CloudFront distributions, and production-grade configurations
